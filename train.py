...
if __name__ == "__main__":
    ...
    for epoch in range(
        ...
        visualizer.reset()  # reset the visualizer: make sure it saves the results to tensorboard at least once every epoch
        ...
        for i, data in enumerate(dataset):  # inner loop within one epoch
            ...
            if (
                ...
                save_result = total_iters % opt.update_tb_freq == 0
