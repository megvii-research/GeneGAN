...
class SplitterGenerator(nn.Module):
    """GeneGAN splitter generator.
    """
    ...
    def splitter(self, input, second_ratio=0.25):
...
class JoinerGenerator(nn.Module):
    """GeneGAN joiner generator.
...
class GlobalDiscriminator(nn.Module):
    """Defines a GlobalGAN discriminator"""
